...
//czy component renderuje się poprawnie
  it('should render correct OrderOption', () => {
    const expectedName = 'image.jpg';
    const expectedType = 'image_text';
  ...
  it('should render correct OrderOption props name', () => {
    const expectedName = 'Order';
  ...
  //Component OrderOption with type
  const optionTypes = {
    ...
    describe(`Component OrderOption with type=${type}`, () => {
      ...
      switch (type) {
        ...
        case 'Datepicker': {
          ...
          it('should run setOrderOption function on Datepicker', () => {
            renderedSubcomponent
              .find(DatePicker)
              .simulate('change', { currentTarget: { value: testValue } });
            expect(mockSetOrderOption).toBeCalledTimes(1);
